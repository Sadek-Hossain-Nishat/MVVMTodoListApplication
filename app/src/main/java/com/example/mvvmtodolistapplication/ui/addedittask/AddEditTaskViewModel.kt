...
class AddEditTaskViewModel @ViewModelInject constructor(
    ...
    private fun updateTask(updatedTask: Task) =viewModelScope.launch {
        ...
        taskDao.update(updatedTask)
            // navaigate back
        addEditTaskEventChannel.send(AddEditTaskEvent.NaviagateBackWithResult(EDIT_TASK_RESULT_OK))
    ...
    private fun createTask(newTask: Task) = viewModelScope.launch {
        ...
        //navigate back
        addEditTaskEventChannel.send(AddEditTaskEvent.NaviagateBackWithResult(ADD_TASK_RESULT_OK))
